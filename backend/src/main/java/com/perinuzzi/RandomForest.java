 ...
 * prediction. Each prediction is tallied up as a confidence score of the model's final prediction
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
public class RandomForest implements Serializable {
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	public RandomForest(int numOfTrees, int numFeatures) {
		train(numOfTrees, numFeatures);
	}
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	public void train(int numOfTrees, int numFeatures) {
		trees = new DecisionTree[numOfTrees];
		for (int i = 0; i < numOfTrees; i++) {
        	DecisionTree newTree = new DecisionTree();
        	newTree.buildTree(numFeatures);  // Takes in the number of features for feature selection
			trees[i] = newTree;
		}
	}
